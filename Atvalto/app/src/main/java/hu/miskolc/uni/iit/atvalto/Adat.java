...
/**
 * Az adat mertekegysegei kozotti atvaltast megvalosito osztaly.
 * Created by TP on 2017. 03. 19..
 */
public class Adat extends AppCompatActivity implements Konvertal, AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = (Button)findViewById(R.id.button_atvalt_adat);
        button.setOnClickListener(this);

        bemenet = (TextView) findViewById(R.id.adat_be_adat);
        kimenet = (TextView) findViewById(R.id.adat_ki_adat);
    }
    ...
    public double Atalakit(String mit, String mibe, double bemenet) {
        ...
        if(mit.equals("terabyte") && mibe.equals("gigabyte")){
            double eredmeny = bemenet*1024;
            return eredmeny;
        }
        if(mit.equals("terabyte") && mibe.equals("megabyte")){
            double eredmeny = bemenet*1024*1024;
            return eredmeny;
        }
        if(mit.equals("terabyte") && mibe.equals("kilobyte")){
            double eredmeny = bemenet*1024*1024*1024;
            return eredmeny;
        }
        if(mit.equals("terabyte") && mibe.equals("byte")){
            double eredmeny = bemenet*1024*1024*1024*1024;
            return eredmeny;
        }
        if(mit.equals("terabyte") && mibe.equals("bit")){
            double eredmeny = bemenet*1024*1024*1024*1024*8;
            return eredmeny;
        }
        ...
        if(mit.equals("gigabyte") && mibe.equals("bit")){
            double eredmeny = bemenet*1024*1024*1024*8;
            return eredmeny;
        }
        ...
        if(mit.equals("megabyte") && mibe.equals("bit")){
            double eredmeny = bemenet*1024*1024*8;
            return eredmeny;
        }
        ...
        if(mit.equals("kilobyte") && mibe.equals("bit")){
            double eredmeny = bemenet*1024*8;
            return eredmeny;
        }
        ...
        if(mit.equals("bit") && mibe.equals("terabyte")){
            double eredmeny = bemenet/8/1024/1024/1024/1024;
            return eredmeny;
        }
        if(mit.equals("bit") && mibe.equals("gigabyte")){
            double eredmeny = bemenet/8/1024/1024/1024;
            return eredmeny;
        }
        if(mit.equals("bit") && mibe.equals("megabyte")){
            double eredmeny = bemenet/8/1024/1024;
            return eredmeny;
        }
        if(mit.equals("bit") && mibe.equals("kilobyte")){
            double eredmeny = bemenet/8/1024;
            return eredmeny;
        }
    ...
    public void beolvas(View view)
    {
        switch(view.getId())
        {
            case R.id.adat_button_0:
                operandustHozzaad("0");
                break;
            case R.id.adat_button_1:
                operandustHozzaad("1");
                break;
            case R.id.adat_button_2:
                operandustHozzaad("2");
                break;
            case R.id.adat_button_3:
                operandustHozzaad("3");
                break;
            case R.id.adat_button_4:
                operandustHozzaad("4");
                break;
            case R.id.adat_button_5:
                operandustHozzaad("5");
                break;
            case R.id.adat_button_6:
                operandustHozzaad("6");
                break;
            case R.id.adat_button_7:
                operandustHozzaad("7");
                break;
            case R.id.adat_button_8:
                operandustHozzaad("8");
                break;
            case R.id.adat_button_9:
                operandustHozzaad("9");
                break;
            case R.id.adat_buttonTorol:
                torol();
                break;
        }
        megjelenit();
    ...
    {
        TextView textview = (TextView) findViewById(R.id.adat_be_adat);
