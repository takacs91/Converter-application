...
/**
 * A nyomas mertekegysegei kozotti atvaltast megvalosito osztaly.
 * Created by TP on 2017. 03. 19..
 */
public class Nyomas extends AppCompatActivity implements Konvertal, AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = (Button)findViewById(R.id.button_atvalt_nyomas);
        button.setOnClickListener(this);

        bemenet = (TextView) findViewById(R.id.adat_be_nyomas);
        kimenet = (TextView) findViewById(R.id.adat_ki_nyomas);
    }
    ...
    public void beolvas(View view)
    {
        switch(view.getId())
        {
            case R.id.nyomas_button_0:
                operandustHozzaad("0");
                break;
            case R.id.nyomas_button_1:
                operandustHozzaad("1");
                break;
            case R.id.nyomas_button_2:
                operandustHozzaad("2");
                break;
            case R.id.nyomas_button_3:
                operandustHozzaad("3");
                break;
            case R.id.nyomas_button_4:
                operandustHozzaad("4");
                break;
            case R.id.nyomas_button_5:
                operandustHozzaad("5");
                break;
            case R.id.nyomas_button_6:
                operandustHozzaad("6");
                break;
            case R.id.nyomas_button_7:
                operandustHozzaad("7");
                break;
            case R.id.nyomas_button_8:
                operandustHozzaad("8");
                break;
            case R.id.nyomas_button_9:
                operandustHozzaad("9");
                break;
            case R.id.nyomas_buttonTorol:
                torol();
                break;
        }
        megjelenit();
    ...
    {
        TextView textview = (TextView) findViewById(R.id.adat_be_nyomas);
