...
/**
 * A terfogat mertekegysegei kozotti atvaltast megvalosito osztaly.
 * Created by TP on 2017. 03. 19..
 */
public class Terfogat extends AppCompatActivity implements Konvertal, AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = (Button)findViewById(R.id.button_atvalt_terfogat);
        button.setOnClickListener(this);

        bemenet = (TextView) findViewById(R.id.adat_be_terfogat);
        kimenet = (TextView) findViewById(R.id.adat_ki_terfogat);
    }
    ...
    public double Atalakit(String mit, String mibe, double bemenet) {
        ...
        if(mit.equals("km3") && mibe.equals("m3")){
            double eredmeny = bemenet*1000000000;
            return eredmeny;
        }
        if(mit.equals("km3") && mibe.equals("dm3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        if(mit.equals("km3") && mibe.equals("cm3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        if(mit.equals("km3") && mibe.equals("mm3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        ...
        if(mit.equals("m3") && mibe.equals("km3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        if(mit.equals("m3") && mibe.equals("dm3")){
            double eredmeny = bemenet*100;
            return eredmeny;
        }
        if(mit.equals("m3") && mibe.equals("cm3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        if(mit.equals("m3") && mibe.equals("mm3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        ...
        if(mit.equals("dm3") && mibe.equals("km3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        if(mit.equals("dm3") && mibe.equals("m3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        if(mit.equals("dm3") && mibe.equals("cm3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        if(mit.equals("dm3") && mibe.equals("mm3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        ...
        if(mit.equals("cm3") && mibe.equals("km3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        if(mit.equals("cm3") && mibe.equals("m3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        if(mit.equals("cm3") && mibe.equals("dm3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        if(mit.equals("cm3") && mibe.equals("mm3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        ...
        if(mit.equals("mm3") && mibe.equals("km3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        if(mit.equals("mm3") && mibe.equals("m3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        if(mit.equals("mm3") && mibe.equals("dm3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
        if(mit.equals("mm3") && mibe.equals("cm3")){
            double eredmeny = bemenet;
            return eredmeny;
        }
    ...
    public void beolvas(View view)
    {
        switch(view.getId())
        {
            case R.id.terfogat_button_0:
                operandustHozzaad("0");
                break;
            case R.id.terfogat_button_1:
                operandustHozzaad("1");
                break;
            case R.id.terfogat_button_2:
                operandustHozzaad("2");
                break;
            case R.id.terfogat_button_3:
                operandustHozzaad("3");
                break;
            case R.id.terfogat_button_4:
                operandustHozzaad("4");
                break;
            case R.id.terfogat_button_5:
                operandustHozzaad("5");
                break;
            case R.id.terfogat_button_6:
                operandustHozzaad("6");
                break;
            case R.id.terfogat_button_7:
                operandustHozzaad("7");
                break;
            case R.id.terfogat_button_8:
                operandustHozzaad("8");
                break;
            case R.id.terfogat_button_9:
                operandustHozzaad("9");
                break;
            case R.id.terfogat_buttonTorol:
                torol();
                break;
        }
        megjelenit();
    ...
    {
        TextView textview = (TextView) findViewById(R.id.adat_be_terfogat);
